...
import mindkeeprAPI from '../api/mindkeepr';
...
export const getMoviesGenre = (name, page, sort) => async (
  ...
  try {
   ...
   /* const genreId = genres
      ...
      .map(el => el.id)
      .join('');*/
    const res = await mindkeeprAPI.get('/movies', {
      params: {
     //   with_genres: genreId,
        page,
        sort_by: sort,
...
export const getMovie = id => async dispatch => {
  try {
    ...
    const res = await mindkeeprAPI.get(`/movies/${id}/`, {
     // params: {
...
export const getMoviesforPerson = (id, page, sort) => async dispatch => {
  try {
    ...
    const res = await tmdbAPI.get(`/movies`, {
      params: {
        with_cast: id,
        page,
        sort_by: sort,
